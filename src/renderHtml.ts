	...
	<body>
		...
		<section class="panel">
			...
			<div class="mobile-inline-carousel" id="mobileInlineCarousel" aria-label="Brand Links">
				...
				<a class="mobile-inline-carousel-slide" href="https://ffister.com/" target="_self"><img src="/r2-fg/assets/mobile-carousel/8.jpg" alt="FFister.com" loading="lazy" fetchpriority="low" decoding="async" /><span class="mobile-inline-carousel-label">FFister.com</span></a>
